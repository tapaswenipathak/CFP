...
from yourcfp.utils import check_correct_volunteer_shift_sign_up
...
class AdministratorLoginRequiredMixin(object):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            pass
        if not admin:
            return render(request, 'yourcfp/no_admin_rights.html')
        else:
...
def get_meetup(request):
    ...
    if response.status_code == 200:
        ...
        return render(request, 'yourcfp/no_connection.html')
